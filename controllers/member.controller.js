...
export async function checkBannedMembers(){
    const res = await fetch(checkBannedMembersEndpoint, {
        method: "GET",
        headers: {
            "Content-Type": "application/json"
        }
